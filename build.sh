...
g++ -finput-charset=UTF-8 -std=c++0x -o fbi -pipe -Wfatal-errors -w src/*.cpp src/irc/*.cpp src/network/*.cpp -lboost_regex -lboost_system -lboost_thread-mt -fpermissive
